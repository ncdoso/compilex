...
void print_tree(struct node * node, int points) {
    int i;
    ...
    printf("\n");
    if(temp->child != NULL) {
        print_tree(temp->child, points+1);
    }
    if(temp->sibling != NULL) {
        print_tree(temp->sibling, points);
    }
}
...
struct node * create_program(char * id, struct node * child) {
...
struct node * create_field_decl(struct node * type, char * id) {
...
struct node * create_var_decl(struct node * type, char * id) {
...
struct node * create_param_decl(struct node * type, char * id) {
...
struct node * create_method_header(struct node * type, char * id, struct node * params) {
...
struct node * create_expression(char * name, struct node * left, struct node * right) {
    struct node * operation = create_node(name, NULL);
